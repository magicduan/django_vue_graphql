...
//   let tagPath="/tag/"
//   let tagName="Tags_"
//   let tag = {path:tagPath+tagsNum.value,name:tagName+tagsNum.value}
//   tags.value.push(tag)
//   emit('changeTags',tags.value)
// }
</script>
...
<template>
  ...
  <div class="my-2 text-center flex flex-wrap justify-center items-center">
    ...
    <!-- <el-button type="primary" @click="addTags()"> Add Tags{{ tagsNum }}</el-button> -->
